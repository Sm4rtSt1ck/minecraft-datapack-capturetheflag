...
execute if score match rounds >= swap rounds run spreadplayers -194 -162 1 3 under -50 false @a[tag=player, team=team_2]
# defense team
execute if score match rounds >= swap rounds run spreadplayers -167 -169 1 3 under -50 false @a[tag=player, team=team_1]
execute if score match rounds < swap rounds run spreadplayers -167 -169 1 3 under -50 false @a[tag=player, team=team_2]
