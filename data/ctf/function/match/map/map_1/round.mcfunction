...
particle minecraft:cloud -190 -42.5 -145.5 2 5 1 1 30 normal
...
particle minecraft:cloud -192.5 -43.5 -184.5 1 5 3 1 40 normal
...
particle minecraft:cloud -196.5 -43.5 -188.5 2 5 1 1 30 normal
