...
item replace entity @a[tag=player, tag=!invisible, scores={ultimate_category=5}] hotbar.7 with carrot_on_a_stick[item_model="minecraft:dragon_head", custom_name='[{"text":"ULTIMATE (Foot eater) [", "color": "#f94bff", "bold": true, "italic": false, "shadow_color": -8379784}, {"keybind":"key.use"}, {"text": "]"}]',custom_data={action:"ultimate"}]
