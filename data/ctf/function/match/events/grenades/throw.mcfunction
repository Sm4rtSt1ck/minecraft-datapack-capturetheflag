...
execute if score game state matches 3 run give @s lingering_potion[\
  max_stack_size=64,\
  custom_name="\"Grenade\"",\
  custom_data={"tags": ["he_grenade"]}\
]
execute if score game state matches 3 run tellraw @s {"text": "You cannot use this now!", "color": "red"}
