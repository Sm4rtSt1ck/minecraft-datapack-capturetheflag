$function ctf:match/freeze/shop/templates/show_item {item: armor_stand, slot: $(slot), cost: $(cost), tag: "", item_name: '$(item_name)', nbt: 'item_model=tnt, entity_data={id:"minecraft:armor_stand", Marker:true, Invisible:true, Tags:["trap", "trap_display", "trap.tnt"], ArmorItems:[{}, {}, {}, {id:"minecraft:tnt"}]}'}
