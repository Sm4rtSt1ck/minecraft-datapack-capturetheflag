...
$execute if score @s[tag=!just_clicked_shop_menu] money matches $(cost).. run function ctf:combine_commands {\
    command_1: 'function ctf:combine_commands {\
        command_1: "item replace entity @s armor.head with minecraft:diamond_helmet",\
        command_2: "item replace entity @s armor.chest with minecraft:diamond_chestplate"\
    }',\
    command_2: 'function ctf:combine_commands {\
        command_1: "item replace entity @s armor.legs with minecraft:diamond_leggings",\
        command_2: "item replace entity @s armor.feet with minecraft:diamond_boots"\
    }'\
}

$function ctf:match/freeze/shop/templates/show_item {item: diamond_chestplate, slot: $(slot), cost: $(cost), tag: "", item_name: '$(item_name)', nbt: ''}
