execute as @s[nbt=!{Inventory:[{components:{"minecraft:custom_data":{tags:["shop", "item"]}}, Slot:18b}]}] run \
    function ctf:match/freeze/shop/defense/custom/gold_armor {slot: 18, cost: 157, item_name: '{"text": "Gold armor"}'}

execute as @s[nbt=!{Inventory:[{components:{"minecraft:custom_data":{tags:["shop", "item"]}}, Slot:20b}]}] run \
    function ctf:match/freeze/shop/defense/custom/iron_armor {slot: 20, cost: 214, item_name: '{"text": "Iron armor"}'}
