...
# Break the borders
# Way 1
fill -181 -42 -122 -181 -52 -108 minecraft:air replace minecraft:prismarine_wall
...
# Way 2
fill -166 -42 -122 -181 -52 -122 minecraft:air replace minecraft:prismarine_wall
...
# Way 3
fill -165 -42 -108 -165 -52 -123 minecraft:air replace minecraft:prismarine_wall
...
# Way 4
fill -165 -41 -122 -181 -41 -108 air replace minecraft:prismarine_slab