...
# Fill the borders
# Way 1
fill -181 -42 -122 -181 -52 -108 minecraft:prismarine_wall replace air
# Way 2
fill -166 -42 -122 -181 -52 -122 minecraft:prismarine_wall replace air
# Way 3
fill -165 -42 -108 -165 -52 -122 minecraft:prismarine_wall replace air
# Way 4
fill -165 -41 -122 -181 -41 -108 minecraft:prismarine_slab replace air
