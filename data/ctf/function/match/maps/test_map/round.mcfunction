...
# Break the borders
# Way 1
fill -190 -50 -146 -191 -36 -146 minecraft:air replace light_blue_stained_glass_pane
...
# Way 2
fill -193 -50 -182 -193 -36 -188 minecraft:air replace light_blue_stained_glass_pane
...
# Way 3
fill -196 -50 -189 -198 -36 -189 minecraft:air replace light_blue_stained_glass_pane
