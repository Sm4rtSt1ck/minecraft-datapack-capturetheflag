...
# command for the command_block: execute as @a[tag=attack, nbt={Inventory:[{id:"minecraft:yellow_banner"}]}, distance=..4] if score game status matches 4 run function ctf:match/event/bring_flag
